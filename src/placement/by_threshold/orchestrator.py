...
if TYPE_CHECKING:
    ...
    from src.placement.by_threshold.scheduler import ThresholdScheduler
...
class ThresholdOrchestrator(BaseOrchestrator):
    def __init__(
        self,
        env: Environment,
        data: SimulationData,
        policy: SimulationPolicy,
        autoscaler: Type[ThresholdAutoscaler],
        scheduler: Type[ThresholdScheduler],
        ...
        self.autoscaler: ThresholdAutoscaler
        self.scheduler: ThresholdScheduler
    ...
    def initializer_process(
        self, autoscaler: Type[ThresholdAutoscaler], scheduler: Type[ThresholdScheduler]
    ) -> Generator:
        if False:
            yield
