...
infrastructure_file="data/qlearning/infrastructure.json"
data_directory="data/qlearning"
workload_trace="data/qlearning/traces/workload-1-1800.json"

# Start scenario #############################

scheduling_strategy="simple_simple"
task_priority="fifo"
cache_policy="fifo"
keep_alive=0
queue_length=100
